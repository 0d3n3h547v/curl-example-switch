...
int main(int argc, char **argv)
{
	...
	FILE *fp;
	CURLcode res;
	char *url = "http://www.projects00.000webhost.com/helloSDL2.nro"; // string used for curl_easy_setopt
	char outfilename[FILENAME_MAX] = "sdmc:/switch/helloSDL2.nro"; // file used for curl_easy_setopt
